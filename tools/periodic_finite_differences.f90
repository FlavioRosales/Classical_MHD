module periodic_finite_differences
  use mpi_lib, only: transpose_z_to_y, transpose_y_to_x
  use periodic_finite_differences_1d
  implicit none
  ...
  interface second_derivative_xx_8
    module procedure :: second_derivative_xx_8_real, second_derivative_xx_8_complex
  end interface second_derivative_xx_8

  interface second_derivative_yy_8
    module procedure :: second_derivative_yy_8_real, second_derivative_yy_8_complex
  end interface second_derivative_yy_8

  interface second_derivative_zz_8
    module procedure :: second_derivative_zz_8_real, second_derivative_zz_8_complex
  end interface second_derivative_zz_8
...
contains
  ...
  !============================================================================!
  function second_derivative_xx_8_real(f, dx) result(df)
    implicit none
    real(kind=8), intent(in) :: dx
    real(kind=8), dimension(:,:,:), intent(in) :: f
    real(kind=8), dimension(size(f,1), size(f,2), size(f,3)) :: f_aux, df
    ...
    do i=1, size(f,1)
      do j=1, size(f,2)
        df(i,j,:) = second_derivative_8_real(f_aux(i,j,:), dx)
      end do
    end do
    df = transpose_y_to_x(df)

  end function second_derivative_xx_8_real
  !============================================================================!
  function second_derivative_xx_8_complex(f, dx) result(df)
    implicit none
    real(kind=8), intent(in) :: dx
    complex(kind=8), dimension(:,:,:), intent(in) :: f
    complex(kind=8), dimension(size(f,1), size(f,2), size(f,3)) :: f_aux, df
    ...
    do i=1, size(f,1)
      do j=1, size(f,2)
        df(i,j,:) = second_derivative_8_complex(f_aux(i,j,:), dx)
      end do
    end do
    df = transpose_y_to_x(df)

  end function second_derivative_xx_8_complex
  !============================================================================!
  function second_derivative_yy_8_real(f, dy) result(df)
    implicit none
    real(kind=8), intent(in) :: dy
    real(kind=8), dimension(:,:,:), intent(in) :: f
    real(kind=8), dimension(size(f,1), size(f,2), size(f,3)) :: f_aux, df
    ...
    do i=1, size(f,1)
      do j=1, size(f,2)
        df(i,j,:) = second_derivative_8_real(f_aux(i,j,:), dy)
      end do
    end do
    df = transpose_z_to_y(df)

  end function second_derivative_yy_8_real
  !============================================================================!
  function second_derivative_yy_8_complex(f, dy) result(df)
    implicit none
    real(kind=8), intent(in) :: dy
    complex(kind=8), dimension(:,:,:), intent(in) :: f
    complex(kind=8), dimension(size(f,1), size(f,2), size(f,3)) :: f_aux, df
    ...
    do i=1, size(f,1)
      do j=1, size(f,2)
        df(i,j,:) = second_derivative_8_complex(f_aux(i,j,:), dy)
      end do
    end do
    df = transpose_z_to_y(df)

  end function second_derivative_yy_8_complex
  !============================================================================!
  function second_derivative_zz_8_real(f, dz) result(df)
    implicit none
    real(kind=8), intent(in) :: dz
    real(kind=8), dimension(:,:,:), intent(in) :: f
    real(kind=8), dimension(size(f,1), size(f,2), size(f,3)) :: df
    ...
    do i=1, size(f,1)
      do j=1, size(f,2)
        df(i,j,:) = second_derivative_8_real(f(i,j,:), dz)
      end do
    end do

  end function second_derivative_zz_8_real
  !============================================================================!
  function second_derivative_zz_8_complex(f, dz) result(df)
    implicit none
    real(kind=8), intent(in) :: dz
    complex(kind=8), dimension(:,:,:), intent(in) :: f
    complex(kind=8), dimension(size(f,1), size(f,2), size(f,3)) :: df
    ...
    do i=1, size(f,1)
      do j=1, size(f,2)
        df(i,j,:) = second_derivative_8_complex(f(i,j,:), dz)
      end do
    end do

  end function second_derivative_zz_8_complex
  !============================================================================!

end module periodic_finite_differences
